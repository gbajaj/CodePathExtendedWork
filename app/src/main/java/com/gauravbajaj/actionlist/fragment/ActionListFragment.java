package com.gauravbajaj.actionlist.fragment;
...
import com.gauravbajaj.actionlist.adapters.ListViewAdapter;
import com.gauravbajaj.actionlist.adapters.SQLiteDataAdapter;
import com.gauravbajaj.actionlist.models.ListViewItem;
import com.gauravbajaj.actionlist.models.TaskDetail;
import com.gauravbajaj.actionlist.utils.ItemsBucketing;

import java.util.ArrayList;

public class ActionListFragment extends Fragment implements ListViewAdapter.ItemClick {
    private static final String TAG = ActionListFragment.class.getSimpleName();
    ...
    public static ActionListFragment newInstance(String param1, String param2) {
    ...
    public void onResume() {
        super.onResume();
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle(" Action List");
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        addItemImageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fragmentTransaction3.replace(R.id.fragment_container, ActionItemFragment.newInstance(0, false)).addToBackStack(null).commit();
    ...
    public void onItemClicked(TaskDetail itemType) {
        ...
        FragmentTransaction fragmentTransaction3 = getFragmentManager().beginTransaction();
        fragmentTransaction3.replace(R.id.fragment_container, ActionItemFragment.newInstance(item_id, true))
